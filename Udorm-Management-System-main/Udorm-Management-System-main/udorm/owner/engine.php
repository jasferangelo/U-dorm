...
function add_property(){
	...
	global $property_id,$province,$city,$street_brgy,$contact_num,$property_type,$price,$total_rooms,$beds,$living_room,$kitchen,$bathroom,$latitude,$path,$p_photo,$property_photo_id,$longitude,$owner_id,$booked,$db;
	...
	$latitude=validate($_POST['latitude']);
        ...
        if(mysqli_num_rows($result1)>0)
      {
   	...
   	$sql = "INSERT INTO add_property (province,city,street_brgy,contact_num,property_type,price,total_rooms,beds,living_room,kitchen,bathroom,latitude,longitude,booked,owner_id) VALUES ('$province','$city','$street_brgy','$contact_num','$property_type','$price','$total_rooms','$beds','$living_room','$kitchen','$bathroom','$latitude','$longitude','$booked','$owner_id')";
