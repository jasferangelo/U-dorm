...
<div id="map_canvas"></div>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="province" required="required">
                                ...
                                <option value="Province 1">Cavite</option>
                                <option value="Province 2">Laguna</option>
                                <option value="Province 3">Batangas</option>
                                <option value="Province 4">Rizal</option>
                                <option value="Province 5">Quezon</option>
                                <option value="Province 6">Mindoro</option>
                                <option value="Province 7">Romblon</option>
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="contact_num" placeholder="Enter Phone Number" name="contact_num">
            </div>
            <div class="form-group">
        ...
        <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="beds">No. of Bed/s:</label>
                    <input type="number" class="form-control" id="beds" placeholder="Enter No. of Bedroom" name="beds">
                  </div>
                  <div class="form-group">
